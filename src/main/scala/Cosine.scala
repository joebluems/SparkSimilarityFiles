...
object Main extends App { 
    ...
    val rawdata = spark.sparkContext.wholeTextFiles(corpusFile).toDF("filename","contents")
    ...
    val newrawdata = spark.sparkContext.wholeTextFiles(newFile).toDF("filename2","contents")
